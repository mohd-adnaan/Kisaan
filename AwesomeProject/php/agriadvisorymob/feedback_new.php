...
$IQ="INSERT INTO feedback ( location_id, farmer_name, state_name, district_name, block_name, mobile_num, feedback_for_bulletin_date, bulletin_useful, bulletin_not_useful, bulletin_effective_part, useful_agri_operations, opinion_weather, shared_w_others, shared_num, economic_benefits, other_info, ratings, farmer_email) VALUES ($location_id,'".$farmer_name."','".$state_name."','".$district_name."','".$block_name."','".$mobile_num."','".$feedback_for_bulletin_date."','".$bulletin_useful."','".$bulletin_not_useful."','". $bulletin_effective_part."','".$useful_agri_operations."','".$opinion_weather."','".$shared_w_others."','". $shared_num."','".$economic_benefits."','".$other_info."','".$ratings."','".$farmer_email)."'";
